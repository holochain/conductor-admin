...
const config = Config.gen({
  alice: Config.dna("/Users/philipbeadle/holochain-2020/flow-state/dna/flowstate.dna.gz", null),
  bobbo: Config.dna("/Users/philipbeadle/holochain-2020/flow-state/dna/flowstate.dna.gz", null),
})
